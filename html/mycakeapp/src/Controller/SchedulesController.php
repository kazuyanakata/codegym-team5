...
class SchedulesController extends AppController
{
    ...
    public function view($id = null)
    {
        $schedule = $this->Schedules->get($id, [
            'contain' => ['Movies', 'Theaters', 'Payments', 'Points', 'ReservationDetails', 'SeatReservations'],
        ]);
    ...
    public function add()
    {
        ...
        $theaters = $this->Schedules->Theaters->find('list', ['limit' => 200]);
        $this->set(compact('schedule', 'movies', 'theaters'));
    }
